...
class Testcodemaker1(unittest.TestCase):
    ...
    def test_init(self, mock_random_choices):
        ...
        self.assertEqual(
            codemaker1.solution,
            "RVBJ",
            "La solution n'a pas été initialisée correctement.",
        )
    ...
    def test_codemaker(self):
        ...
        self.assertEqual(
            codemaker1.codemaker("RVBJ"),
            (4, 0),
            "L'évaluation est incorrecte pour une combinaison exacte.",
        )

        # Cas 2 : Combinaison avec une bonne couleur mal placée
        self.assertEqual(
            codemaker1.codemaker("VJRB"),
            (0, 4),
            "L'évaluation est incorrecte pour une combinaison avec 4 mal placés.",
        )

        # Cas 3 : Combinaison avec 2 bien placés et 2 mal placés
        self.assertEqual(
            codemaker1.codemaker("RVJB"),
            (2, 2),
            "L'évaluation est incorrecte pour 2 bien placés et 2 mal placés.",
        )

        # Cas 4 : Combinaison sans couleurs présentes
        self.assertEqual(
            codemaker1.codemaker("NNMM"),
            (0, 0),
            "L'évaluation est incorrecte pour une combinaison sans couleurs présentes.",
        )
