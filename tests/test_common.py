...
class TestCommonFunctions(unittest.TestCase):
    ...
    def test_evaluation(self):
        ...
        # Cas standard
        self.assertEqual(
            common.evaluation("RVJB", "RVBR"), (2, 1)
        )  # 2 bien placées, 2 mal placées
        ...
        self.assertEqual(
            common.evaluation("RVBJ", "JBRV"), (0, 4)
        )  # Tout est mal placé

        # Nouveaux cas de test
        self.assertEqual(
            common.evaluation("RGBJ", "RGBJ"), (4, 0)
        )  # Toutes les couleurs bien placées
        self.assertEqual(
            common.evaluation("JRGB", "RGBJ"), (0, 4)
        )  # Toutes les couleurs présentes mais mal placées
        self.assertEqual(
            common.evaluation("RGGB", "RGBJ"), (2, 1)
        )  # Certaines couleurs bien placées, d'autres mal placées
        self.assertEqual(
            common.evaluation("JJJJ", "RGBJ"), (1, 0)
        )  # Une seule couleur correcte bien placée
        self.assertEqual(
            common.evaluation("BJGR", "RGBJ"), (0, 4)
        )  # Toutes les couleurs mal placées
        self.assertEqual(
            common.evaluation("RRRR", "RGBJ"), (1, 0)
        )  # Couleurs répétées et mal placées
